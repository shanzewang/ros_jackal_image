...
CURRENT_DIR = "/home/jidan/AVWorkSpace/jackal_ws/src/ros_jackal"

BUFFER_PATH = os.getenv('BUFFER_PATH')
# if not BUFFER_PATH:
#     BUFFER_PATH = "./local_buffer"
if not BUFFER_PATH:
    BUFFER_PATH = join(CURRENT_DIR, "local_buffer")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--policy_path', type = str, default=BUFFER_PATH)
